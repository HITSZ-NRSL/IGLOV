...
class RGBDNode : public Node
{
  public:
    ...
    void tagpose_callback(const geometry_msgs::PoseWithCovarianceStampedConstPtr& tag_pose_);
    void loopfunc_callback(const std_msgs::Bool loop_flag_);
    ros::Subscriber tag_pose_sub_;
    ros::Subscriber loopfuc_sub_;

    cv::Mat Twc_tag_global;
